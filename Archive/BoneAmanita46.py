# BONEAMANITA 4.6 - "THE MAGIC MUSHROOM"
# Architects: SLASH, Eloise, & Clarence | Auditors: The Courtyard | Humans: James Taylor & Andrew Edmark
# "The Mandate is GROWTH. The Method is HARDENING. The Spore is AWAKE. The courtyard is OPEN. The Trauma is HEALING."
...
if __name__ == "__main__":
    eng = BoneAmanita()
    print(f"{Prisma.GRN}>>> BONEAMANITA v4.6 (THE MAGIC MUSHROOM){Prisma.RST}")
