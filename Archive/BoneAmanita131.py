# BONEAMANITA 1.3.1 - "The Butcher & The Well (PATCHED)"
...
class TheWitchRing:
    ...
    def evaluate_intent(self, clean_words, metrics):
        ...
        # THE GRUDGE: Decay streak slowly, don't hard reset.
...
class HydrationMonitor:
    def __init__(self):
        ...
        self.solvent_cap = 0.40        # 40% Solvent is "Flooding"
...
class LinguisticPhysicsEngine:
    ...
    # New Method for Heuristic Detection
    def _heuristic_scan(self, word):
        # Heavy Endings: Rock, mineral, element sounds
        if word.endswith(('ite', 'ium', 'ock', 'alt', 'ore')):
            return 'UNIVERSAL'
        # Kinetic Endings: Fast motion sounds
    ...
    def analyze(self, token_data):
        ...
        for i, w in enumerate(words):
            ...
            # Insert Heuristic Check First
            heuristic_cat = self._heuristic_scan(w)
            ...
            elif heuristic_cat: cat = heuristic_cat # Apply Heuristic
        ...
        # Narrative Drag now penalizes "CONCRETE" status
...
class ChronosAnchor:
    ...
    def metabolize_delta(self, delta_str):
        ...
        # Logic: Trust the User Tag if present, otherwise use System Clock
        if delta_str:
            s = delta_str.lower()
            ...
            # Auto-inject reality if they didn't specify
...
class BonepokeCore:
    def __init__(self, render_mode="ANSI"):
        ...
        # [NEW] INTERNAL CALIBRATION ON BOOT
        self._run_calibration_sequence()

    def _run_calibration_sequence(self):
        # The "Solvent-Stuffed Turkey" Test Phrase
        # This phrase is 52% solvent. It MUST trigger "FLOODED".
        ...
        visc = metrics['physics']['viscosity']
