# BONEAMANITA 6.4 - "THE COMPROMISE"
...
class TheMarmChorus:
    ...
    LENSES = {
        ...
        "JESTER":   {"color": Prisma.YEL, "role": "The Paradox",    "trigger": "TOO_SMOOTH"},
...
class TheProjector:
    def broadcast(self, engine, m, signals, lens_data, clean_text):
        ...
        # THE HUD (Simplified)
        # Shows E (Drift) and B (Charge) visually
...
class LifecycleManager:
    ...
    def run_cycle(self, text):
        ...
        lens_data = self.eng.chorus.consult(m["physics"]) # Returns (Name, Msg)
        ...
        self._grow(m, meta) # Updates Stamina/Health
        ...
        self._render(m, meta, cosmic_msg, lens_data, mirror_msg, kintsugi_msg)
    ...
    def _render(self, m, meta, cosmic_msg, lens_data, mirror_msg, kintsugi_msg):
        ...
        signals = {
            ...
            "strat": self.eng.wise.architect(m, lens_data[0], False)[1],
...
if __name__ == "__main__":
    eng = BoneAmanita()
    print(f"{Prisma.GRN}>>> BONEAMANITA v6.3 {Prisma.RST}")
