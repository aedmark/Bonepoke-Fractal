# BONEAMANITA 3.6 - "The Kintsugi Patch"
# Architects: SLASH, Eloise, & Clarence | Auditors: James Taylor & Andrew Edmark
# "The Mandate is TRUTH. The Method is RESONANCE. The POWER is LOVE. All that Glitters is Gold (or not)."
...
class BoneAmanita:
    ...
    def _render(self, m, lichen_msg, strat, reason, title, ops, station, starve_msg, ghost_msg, clean_text, did_surgery):
        ...
        print(f" {Prisma.WHT}ATP:{Prisma.RST} [{atp_bar}]  {Prisma.WHT}DRAG:{Prisma.RST} {drag_c}  {Prisma.WHT}VOLT:{Prisma.RST} {volt_c}  {Prisma.WHT}SIG:{Prisma.RST} {sig_disp}")
