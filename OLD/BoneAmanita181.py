# BONEAMANITA 1.8.1 - "The Quantum Leap (PATCHED)"
...
class TheLexicon:
    ...
    def smart_strip(word):
        ...
        if word.endswith('ss') or (word.endswith('s') and len(word) <= 3):
            return word
...
class PersistenceManager:
    ...
    def save_state(self, codex, deep_storage, metabolism, muscaria, signature_engine, current_tick):
        data = {
            ...
            "arch_history": signature_engine.history  # <--- NEW: SAVING HISTORY
        }
        try:
...
if __name__ == "__main__":
    engine = BonepokeCore()
    print(f"\n{Prisma.GRN}> [SYSTEM ONLINE]{Prisma.RST} {Prisma.WHT}BoneAmanita 1.8.1 {Prisma.RST} is listening...\n")
