# BONEAMANITA 4.4 - "THE SPHERICAL COW"
# Architects: SLASH, Eloise, & Clarence | Auditors: James Taylor & Andrew Edmark
# "The Mandate is GROWTH. The Method is HARDENING. The Spore is AWAKE. The Symbiont is EVOLVING. The Data is SALVAGED. The courtyard is OPEN."
...
class BoneAmanita:
    ...
    def _render(self, m, lichen_msg, strat, reason, title, ops, station, starve_msg, ghost_msg, clean_text, did_surgery, battery_log, lazarus_msg, spore_msg=None, ta_val=0.0, omens=[], dream_msg=None, mode="LABORATORY"):
        ...
        if mode == "COURTYARD":
            ...
            # If there's a dream, it looks like a cloud
...
if __name__ == "__main__":
    eng = BoneAmanita()
    print(f"{Prisma.GRN}>>> BONEAMANITA v4.4. MOO.{Prisma.RST}")
