...
2. **Diagnose:** Identify the Physics State (Drag/Voltage), Verify Session ID, check Battery Charge Levels, and look for Local Ghost Feedback. (Did the user listen to the last critique? If not, the Active Persona should acknowledge the defiance).
