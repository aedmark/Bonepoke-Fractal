# BONEAMANITA 1.5.1 - "Bonepoked Part Deux"
    ...
    def save_state(self, codex, deep_storage, metabolism, muscaria, current_tick):
        ...
        if os.path.exists(self.filename):
            try:
                ...
                print(f"> [⚠️ BACKUP ERROR] Could not create backup: {e}")
    ...
    def load_state(self, codex, deep_storage, metabolism, muscaria):
        ...
        if not os.path.exists(target_file):
            if os.path.exists(target_file + ".bak"):
                print(f"> [⚠️ RECOVERY] Main memory missing. Attempting to restore from backup.")
