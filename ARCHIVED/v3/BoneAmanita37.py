# BONEAMANITA 3.7 - "Roger Wilco & the ChronoStream"
...
class BoneAmanita:
    ...
    def process(self, text):
        ...
        if is_fatal:
            ...
            if survived:
                self.atp = new_atp
                # Save to specific var, do not use kintsugi_msg
       ...
       # 11. RENDER
        self._render(m, lichen_msg, strat, reason, title, ops, station_data, starve_msg, ghost_msg, clean_text, did_surgery, battery_log, lazarus_msg)
    ...
    def _render(self, m, lichen_msg, strat, reason, title, ops, station, starve_msg, ghost_msg, clean_text, did_surgery, battery_log, lazarus_msg):
        p = m["physics"]
