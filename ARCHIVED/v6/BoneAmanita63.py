# BONEAMANITA 6.3 - "ELEMENTARY EDITION"
...
class BoneConfig:
    ...
    TOXIN_REGEX = None
    SUGAR_WORDS = {k for k, v in LOW_DENSITY_MAP.items() if v[0] < 3.0}
    @classmethod
    def compile(cls):
        toxins = [t for t, v in cls.LOW_DENSITY_MAP.items() if v[0] >= 3.0]
...
class LifecycleManager:
    ...
    def run_cycle(self, text):
        ...
        self._render(m, metabolic_data, cosmic_msg, mode, station_data, kintsugi_msg, mirror_msg)
    ...
    def _render(self, m, meta, cosmic_msg, mode, station, kintsugi_msg):
        ...
        if mirror_msg: battery_log.append(f"{Prisma.MAG}🪞 {mirror_msg}{Prisma.RST}")
        signals = {
...
class BoneAmanita:
    def __init__(self):
        ...
        self.navigator = ManifoldNavigator()
