# BONEAMANITA 7.4 - "MITOCHONDRIAL EVE"
...
if __name__ == "__main__":
    eng = BoneAmanita()
    print(f"{Prisma.GRN}>>> BONEAMANITA v7.4 'MITOCHONDRIAL EVE' {Prisma.RST}")
