# BONEAMANITA 9.2.2 "LET YOUR LOVE FLOW"
...
if __name__ == "__main__":
    eng = BoneAmanita()
    print(f"{Prisma.paint('>>> BONEAMANITA 9.2.2', 'G')}")
