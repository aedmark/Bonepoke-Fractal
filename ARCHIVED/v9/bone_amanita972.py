# BONEAMANITA 9.7.2 "THE STRUNK & WHITE PROTOCOL"
        ...
        try:
            ...
            if bureau_result:
                ...
                return {
                    ...
                    "metrics": self.eng._get_metrics(self.eng.bio.mito.state.atp_pool), # Explicitly passing ATP
            ...
            return {
                ...
                "logs": ctx.logs,
                "metrics": self.eng._get_metrics(0.0)
            }
