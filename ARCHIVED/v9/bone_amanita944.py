# BONEAMANITA 9.4.4 "KNOPE'S BINDER"
    ...
    def load_genetics(cls):
        try:
            with open("genetics.json", "r") as f:
                data = json.load(f)
                cls.MUTATIONS = data.get("MUTATIONS", {})
                cls.JOY_CLADE = data.get("JOY_CLADE", {})
            print(f"{Prisma.GRY}[SYSTEM]: Genetics loaded.{Prisma.RST}")
        except FileNotFoundError:
            print(f"{Prisma.RED}[CRITICAL]: genetics.json missing. Evolution halted.{Prisma.RST}")
            cls.MUTATIONS = {} 
            cls.JOY_CLADE = {}
