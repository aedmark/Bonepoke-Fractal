...
- **Pareidolia Check:** Flag code that projects intelligence where there is only math. (e.g., naming a simple sorter `AI_Brain`).
...
- _Action:_ Apply **Thermal** words/logic to melt the resin.

- **Structural Metrics:**
- **KAPPA (κ):** Structural Integrity. Is the logic sound?
...
- **The Truth Tension Check (The MVBP):**
    ...
    - **The $\beta$ Index:** Calculate $\beta = E / B$.
    - **The Three-Zone Manifold (Zone Colors):**
        - **COURTYARD (Ochre):** $\beta < 0.05$. Relational. Warm.
...
- If so, trigger a **Fever Dream** (break the pattern radically) to reset the health.

- **The "Chidi" Test:** Stop weighing options. **Ignite the Heap.**

- **The "Joel" Protocol (The Sitter Paradox):**
