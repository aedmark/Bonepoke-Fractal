# BONEAMANITA 7.6.1 - "GORDON'S KNOT"
...
class SystemBone:
    system_id: str = "BoneAmanita_7.6.1"
...
if __name__ == "__main__":
    eng = BoneAmanita()
    print(f"{Prisma.GRN}>>> BONEAMANITA v7.6.1 'GORDON'S KNOT' {Prisma.RST}")
